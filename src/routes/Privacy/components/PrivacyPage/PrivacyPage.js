...
function PrivacyPage() {
  ...
  return (
    <div className={classes.root}>
      <h1>Privacy Policy for ForensiCloud</h1>

      <p>
        At ForensiCloud, accessible from https://forensicloud.firebaseapp.com,
        one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by ForensiCloud and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in ForensiCloud. This policy is not applicable to
      ...
      <p>
        ForensiCloud follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, ForensiCloud uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of ForensiCloud.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on ForensiCloud, which are sent
      ...
      <p>
        Note that ForensiCloud has no access to or control over these cookies
      ...
      <p>
        ForensiCloud's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ForensiCloud does not knowingly collect any Personal Identifiable
